...
/**
 * @author r.moharana
 * This class is the webdriver factory, it return the driver type(local or remote) based on the value provided in properties file
 */
public class WebDriverLibrary {
	...
	//create driver based on the input: LOCAL OR REMOTE
	...
	//Not yet implemented for this task
	// through selenium grid: by initializing remotewebdriver we can achieve different browser with os for parallel execution
